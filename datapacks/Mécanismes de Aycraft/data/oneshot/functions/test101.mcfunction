...
execute positioned 0 79 10000 run function oneshot:test102

execute if score Booleen commun_Variable matches 1 run data merge block ~ ~ ~ {Text1:"{\"text\":\"====*====\"}",Text2:"{\"text\":\"RIEN\"}",Text3:"{\"text\":\"RIEN\"}",Text4:"{\"text\":\"====*====\"}"} 