...
# On sauvegarde le statut actuel de la map (-1 ou 0..4)

execute if score VersionMap commun_Variable matches 1 if block ~ ~ ~ barrel{Items:[{Slot:1b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1
execute if score VersionMap commun_Variable matches 2 if block ~ ~ ~ barrel{Items:[{Slot:2b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1
execute if score VersionMap commun_Variable matches 3 if block ~ ~ ~ barrel{Items:[{Slot:3b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1
execute if score VersionMap commun_Variable matches 4 if block ~ ~ ~ barrel{Items:[{Slot:4b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1
execute if score VersionMap commun_Variable matches 5 if block ~ ~ ~ barrel{Items:[{Slot:5b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1
execute if score VersionMap commun_Variable matches 6 if block ~ ~ ~ barrel{Items:[{Slot:6b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1
execute if score VersionMap commun_Variable matches 7 if block ~ ~ ~ barrel{Items:[{Slot:7b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1
execute if score VersionMap commun_Variable matches 8 if block ~ ~ ~ barrel{Items:[{Slot:8b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1
execute if score VersionMap commun_Variable matches 9 if block ~ ~ ~ barrel{Items:[{Slot:9b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1
execute if score VersionMap commun_Variable matches 10 if block ~ ~ ~ barrel{Items:[{Slot:10b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable -1

execute if score VersionMap commun_Variable matches 1 unless block ~ ~ ~ barrel{Items:[{Slot:1b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0
execute if score VersionMap commun_Variable matches 2 unless block ~ ~ ~ barrel{Items:[{Slot:2b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0
execute if score VersionMap commun_Variable matches 3 unless block ~ ~ ~ barrel{Items:[{Slot:3b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0
execute if score VersionMap commun_Variable matches 4 unless block ~ ~ ~ barrel{Items:[{Slot:4b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0
execute if score VersionMap commun_Variable matches 5 unless block ~ ~ ~ barrel{Items:[{Slot:5b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0
execute if score VersionMap commun_Variable matches 6 unless block ~ ~ ~ barrel{Items:[{Slot:6b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0
execute if score VersionMap commun_Variable matches 7 unless block ~ ~ ~ barrel{Items:[{Slot:7b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0
execute if score VersionMap commun_Variable matches 8 unless block ~ ~ ~ barrel{Items:[{Slot:8b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0
execute if score VersionMap commun_Variable matches 9 unless block ~ ~ ~ barrel{Items:[{Slot:9b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0
execute if score VersionMap commun_Variable matches 10 unless block ~ ~ ~ barrel{Items:[{Slot:10b,id:"minecraft:magenta_wool"}]} run scoreboard players set Statut commun_Variable 0



# Puis on delete les données de la laine utilisée par la map (en prenant soin de sauvegarder le statut de la laine
...
# Ensuite on tire une nouvelle map dans le barrel de random en fonction du mini jeu et du mode de jeu adapté et on récupère le numero de la map tirée et le statut de cette dernière (-1 si précisé, 0 sinon)
