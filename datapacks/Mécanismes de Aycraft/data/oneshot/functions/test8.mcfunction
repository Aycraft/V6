...
# Cas Statut = -1
	# Pas d'erreur si la map est pleine, on envoie juste la personne en spectateur
execute if score Jeu commun_Variable matches 0 if score Statut commun_Variable matches -1 if score Booleen commun_Variable matches 1 run function oneshot:test11
execute if score Jeu commun_Variable matches 0 if score Statut commun_Variable matches -1 if score Booleen commun_Variable matches 0 run tellraw @s {"text":"Un problème (1) est survenu, contactez un membre du staff","color":"red"}
...
# Cas autre
execute if score Jeu commun_Variable matches 0 unless score Statut commun_Variable matches -1..4 run tellraw @s {"text":"Un problème (3) est survenu, contactez un membre du staff","color":"red"}
