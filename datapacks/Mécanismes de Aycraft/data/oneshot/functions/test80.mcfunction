...
execute unless score res commun_Compare matches 0 if score x commun_Variable matches 0.. if score z commun_Variable matches 0.. positioned 0 0 0 run function oneshot:test81
