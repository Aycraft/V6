...
tag @a[name=!aygame,name=!Fabaure,name=!Haugtolas,name=!mathaym25,name=!Catsuri33,name=!_Fire_Ghost_,name=!matiousse12,name=!Multicort,name=!Vianpyro,name=!Silvathor,name=!AxolotlDetective,name=!AtikaZ,name=!Ayokoo,name=!Kawabii_,name=!_yorru_,name=!zaled] add commun_EstJoueurRandom
...
execute as Silvathor unless entity @s[scores={commun_Grade=10},team=fIngenieur] unless entity @s[scores={commun_Grade=10},tag=commun_PasBesoinGrade] run function commun:grades/protection/correction
...
execute as AxolotlDetective unless entity @s[scores={commun_Grade=9},team=gArchitecte] unless entity @s[scores={commun_Grade=9},tag=commun_PasBesoinGrade] run function commun:grades/protection/correction
